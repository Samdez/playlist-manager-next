...
async function UserPlaylists() {
    ...
    console.log('🚀 ~ UserPlaylists ~ me:', me);
    console.log('🚀 ~ UserPlaylists ~ token:', token);
...
// return <div>User Playlists: {playlists.body.items.map(el => el.name)}</div>;
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1fcea8._.js.map