...
"[project]/app/actions/add-cron.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$add$2d$cron$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/actions/add-cron.ts [app-ssr] (ecmascript)");
...
function PlaylistDetail() {
    ...
    function handleShufflePlaylist() {
        if (playlist) {
            const shuffledTracks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shufflePlaylist"])(playlist);
    ...
    async function handleSyncPlaylist(playlist) {
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["syncPlaylist"])(params.id, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"], playlist);
        } catch (error) {
            if (error instanceof Error) {
                throw new Error(error.message);
            }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__62154f._.js.map