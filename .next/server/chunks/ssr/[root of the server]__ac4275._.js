...
function MyPlaylists() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$1$2e$7_react$2d$dom$40$19$2e$0$2e$0_react$40$19$2e$0$2e$0_$5f$react$40$19$2e$0$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const authenticate = async ()=>{
            ...
            console.log('🚀 ~ authenticate ~ pbUser:', pbUser);
            if (!pbUser) {
                await pb.collection('spotify_users').create({
                    spotifyUserId: currentUser.id
                });
            }
            const playlists = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"].playlists.getUsersPlaylists(currentUser.id).then((res)=>res.items.filter((item)=>item.owner.id === currentUser.id));
            console.log('🚀 ~ authenticate ~ playlists:', playlists);
        };
        authenticate();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ac4275._.js.map